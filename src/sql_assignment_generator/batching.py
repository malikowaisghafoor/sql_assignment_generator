...
ERROR_DETAIL_TAGS: dict[SqlErrors, set[DetailTag]] = {
    SqlErrors.SYN_10_SYNONYMS: {DetailTag.INCONSISTENT_NAMING},
    SqlErrors.SYN_4_UNDEFINED_COLUMN: {DetailTag.COMPLEX_NAMES},
    SqlErrors.SYN_7_UNDEFINED_OBJECT: {DetailTag.COMPLEX_NAMES},
    SqlErrors.SYN_9_MISSPELLINGS: {DetailTag.COMPLEX_NAMES},
    SqlErrors.SYN_11_OMITTING_QUOTES_AROUND_CHARACTER_DATA: {DetailTag.REQUIRES_STRING_ATTRS},
    SqlErrors.SYN_21_COMPARISON_WITH_NULL: {DetailTag.REQUIRES_NULL},
    SqlErrors.SEM_41_DISTINCT_IN_SUM_OR_AVG: {DetailTag.REQUIRES_NUMERIC},
    SqlErrors.SEM_45_MIXING_A_GREATER_THAN_0_WITH_IS_NOT_NULL: {DetailTag.REQUIRES_EMPTY_STRINGS},
    SqlErrors.SEM_46_NULL_IN_IN_ANY_ALL_SUBQUERY: {DetailTag.REQUIRES_NULL},
    SqlErrors.LOG_60_JOIN_ON_INCORRECT_COLUMN_MATCHES_POSSIBLE: {DetailTag.REQUIRES_COMPOSITE_FK},
    SqlErrors.LOG_72_MISSING_DISTINCT_FROM_SELECT: {DetailTag.REQUIRES_DUPLICATES},
    SqlErrors.LOG_78_DISTINCT_AS_FUNCTION_PARAMETER_WHERE_NOT_APPLICABLE: {DetailTag.REQUIRES_DUPLICATES},
    SqlErrors.LOG_79_MISSING_DISTINCT_FROM_FUNCTION_PARAMETER: {DetailTag.REQUIRES_DUPLICATES},
    SqlErrors.COM_84_UNNECESSARY_JOIN: {DetailTag.REQUIRES_FK},
    SqlErrors.COM_89_UNNECESSARILY_COMPLICATED_SELECT_IN_EXISTS_SUBQUERY: {DetailTag.REQUIRES_DUPLICATES},
    SqlErrors.COM_95_GROUP_BY_WITH_SINGLETON_GROUPS: {DetailTag.REQUIRES_DUPLICATE_GROUPBY},
}
